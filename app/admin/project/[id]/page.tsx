...
import { ArrowLeft, Building2, MapPin, IndianRupee, Clock, TrendingDown, TrendingUp, AlertCircle, CheckCircle2, MessageSquareText, BarChart3, Activity } from 'lucide-react';
...
export default function ProjectDetailsPage() {
  ...
  const progressGap = project.physicalProgress - project.plannedProgress;
