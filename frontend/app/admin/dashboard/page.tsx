...
import { mockProjects, mockAlerts, normalizeStateName } from '../../../data/mockData';
...
export default function AdminDashboard() {
  ...
  const filteredProjects = mockProjects.filter(p => {
    ...
    const stateMatch = filters.state === 'All' || normalizeStateName(p.state) === normalizeStateName(filters.state);
