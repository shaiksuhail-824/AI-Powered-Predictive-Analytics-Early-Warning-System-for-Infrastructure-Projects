...
> [!IMPORTANT]
> **Data Status Notice**: Evaluation results below are derived from **SYNTHETIC / DEMO DATA**. They validate mathematical correctness, probability calibration, and pipeline integrity for the PAIMANA prototype.
